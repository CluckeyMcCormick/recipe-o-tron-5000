class ItemClassesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @item_class.save
        ...
        format.json { render :show, status: :created, location: @item_class }
      else
  ...
  def update
    respond_to do |format|
      if @item_class.update(item_class_params)
        ...
        format.json { render :show, status: :ok, location: @item_class }
      else
  ...
  def destroy
    @item_class.destroy
    respond_to do |format|
      format.html { redirect_to item_classes_url, notice: 'Item class was successfully destroyed.' }
